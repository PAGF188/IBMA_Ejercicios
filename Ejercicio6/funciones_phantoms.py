...
def breast_phantom(size,energy):
    coef_air = read_file(energy, './coefs/coefAtenuacionAir.csv')
    coef_adipose = read_file(energy, './coefs/coefAtenuacionAdipose.csv')
    coef_breast = read_file(energy, './coefs/coefAtenuacionBreast.csv')
    coef_soft = read_file(energy, './coefs/coefAtenuacionSoft.csv')

    print("coef_air:", coef_air)
    print("coef_adipose:", coef_adipose)
    print("coef_breast:", coef_breast)
    print("coef_soft:", coef_soft)
    ...
    #print((stbt_z + stbt_z+soft_size)/2)
    ...
    #print((stat_z + stat_z+soft_size)/2)
    ...
    #print((stsat_z + stsat_z+soft_size)/2)
    return np.transpose(phantom, (2, 1, 0))
